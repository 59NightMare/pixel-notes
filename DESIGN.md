...
- New/changed components: `BrandMark`、`HeaderActions`、语言切换、`NewsletterForm`、页脚品牌导航、Hero 操作链接、主题索引、分类/标签内容地图、精选文章卡、紧凑文章卡、作者档案与联系行、`Comments`、PWA 注册、离线页和 CMS 管理入口；沿用现有 Pixelium 控件与硬边框语言。
